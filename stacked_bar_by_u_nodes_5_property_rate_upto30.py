...
#print "u2"
#print pre_A_2
pre_A_2 = [[4, 100, 4, 4,0,0,0,0], [0, 100, 0, 0,0,0,0,0]]
for item in pre_A_2:
  while len(item) != 17:
    item.append(0)
...
pre_A_3 = [[4, 4, 100, 4,0,0,0,0], [0, 5, 104, 0,0,0,0,0]]
for item in pre_A_3:
  while len(item) != 17:
    item.append(0)
...
pre_A_4 = [[4, 4, 4, 100, 0, 0,0,0], [0, 2068, 1978, 402, 40, 0,0,8]]
for item in pre_A_4:
  while len(item) != 17:
    item.append(0)
...
plt.text(-4,0,"Rate")
plt.tight_layout()
plt.savefig('sb_nodes_5_by_u_property_rate_upto30.svgz')
plt.show()
